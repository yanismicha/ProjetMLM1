...
Après avoir eu l'idée de créer une carte interactive dans laquelle nous listerions tout coins de grimpe avec leurs caractéristique et la possibilité en se plaçant sur une carte de visualiser les endroits les plus proche pour escalader, nous avons préférer partir sur une autre idée: la prédiction sur un jeu de donnée relatif à l'escalade.  
...
- Ajouter la possibilité de rajouter/supprimer une ligne dans la data directement depuis l'interface. - Ajouter graphique interactif avec animation  
